...
| ![GitHub code size in bytes](https://img.shields.io/github/languages/code-size/$OWNER/$REPOSITORY) | ![GitHub Repo stars](https://img.shields.io/github/stars/$OWNER/$REPOSITORY?color=%23eac54f) ![GitHub downloads](https://img.shields.io/github/downloads/$OWNER/$REPOSITORY/total?style=flat) ![unique views](https://img.shields.io/badge/unique_views-$UNIQUE_VIEWS-blue) ![total views](https://img.shields.io/badge/total_views-$TOTAL_VIEWS-blue) |
